#  imagine that you're a database administrator who wants to quickly track all the 
# unique names in your database during some troubleshooting exercises. You attempt 
# to do this using a hash set, as demonstrated in the given code.
